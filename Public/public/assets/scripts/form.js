...
class ContactForm {
    constructor() {
        ...
        this.MESSAGE_TEMPLATES = {
            'new-website': `Hi Godlove, I run a [type of business, e.g. clothing shop / salon / school etc] in [city].
...
[Add any extra details to help me understand your business]`,
            ...
            'fix-website': `Hi Godlove, I have a website at [yoursite.com] but it's not bringing in customers.

People visit and then leave without calling or messaging. I want to fix that.

Can you take a look and tell me what's wrong?`,

            'book-call': `Hi Godlove, I'd like to schedule a call to discuss [what you want to talk about].

I'm available [days and times, e.g. Mon–Wed after 4pm].

What times work for you?`,

            'project-question': `Hi Godlove, I have a question about your project [project name].
...
[Write your message here.]`
    ...
    async handleSubmit(e, target='') {
        ...
        const payload = {
            ...
            siteKey:   "godlove-tikum-v2",
            sessionId: localStorage.getItem('gtSessionId') || '',
        };
        
        
        try {
            // open WhatsApp if the visitor wants. 
            // also do a silent background call
            if (target==='whatsapp') {
    ...
    openWhatsapp(payload){
        if(!payload) return;
        const message = `
Greetings Godlove. I came across your portfolio at *${payload.page}*
